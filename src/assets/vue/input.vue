    ...
    <div class="input">
        <div class="nr">
            ...
            <div class="centerInput">
               <div class="centerInputLeft">
                    <span></span>
               </div>
               <div class="centerInputright" @click ='goSearch'>
...
export default {
    ...
    created(){
        ...
        window.jsonpCBKA = res=>{
            this.keyword = res.searchwords[0].showword
        }
    },
    methods:{
        goSearch(){
